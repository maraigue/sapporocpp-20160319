// （2変数）準ニュートン法により関数の最小値を求める
// 
// ※対象とする関数が凸かつ微分可能である必要がある
...
// ∂f/∂y = 2x + 6y + 5
// 
// 本当は、以下のものをまとめて行列にしたものも返さないとならない（ヘシアン）
// ∂f^2/∂x^2 = 2
// ∂f^2/∂y^2 = 6
// ∂f^2/∂x∂y = 2
// ただしここでは、ヘシアンを疑似的に求めることで最小値計算に利用する方法
// （準ニュートン法）を利用しているため、ヘシアンを返す必要はなくなっている。
// pseudo_inv_hessian が疑似的に求められたヘシアンである。
